...
from app.config import API_SUBDOMAIN, DEBUG, LOCAL_SUBDOMAIN
from app.services import is_valid_subdomain
...
async def domain_middleware_utils(request: Request, call_next: Any) -> Any:
    ...
    if subdomain != API_SUBDOMAIN and not is_valid_subdomain(subdomain):
        return JSONResponse(
            status_code=status.HTTP_404_NOT_FOUND,
